...
public class UIScript : MonoBehaviour
{
	...
	public Text[] numberLabels = new Text[4];
	...
	private int[] playersHealth = new int[4];
	...
	private void Start()
	{
        ...
        for (int i = 1; i < 4; i++)
        {
            ...
            else if (GameObject.FindGameObjectWithTag("Player" + i.ToString()) != null)
                {
                    numberOfPlayers++;
                }
        }
		...
		{
			if(gameType == GameType.Score || gameType == GameType.Endless)
			{
